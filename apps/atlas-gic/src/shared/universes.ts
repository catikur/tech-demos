/** Static delayed-tape universes. Not official index reconstitutions. */
export const SP100 = [
  ...
  "UNP", "UPS", "USB", "V", "VZ", "WFC", "WMT", "XOM", "PLTR", "UBER",
] as const;

export const NDX100 = [
  "AAPL", "ABNB", "ADBE", "ADI", "ADP", "ADSK", "AEP", "AMAT", "AMD", "AMGN",
  "AMZN", "ARM", "ASML", "AVGO", "AZN", "BIIB", "BKNG", "BKR", "CCEP", "CDNS",
  ...
  "VRSK", "VRTX", "WBD", "WDAY", "XEL", "ZS", "MSTR", "PLTR", "APP", "AXON",
] as const;
